...
class Model(nn.Module):
    def __init__(self):
        ...
        self.cnn_fc = nn.Linear(64, 128)  # Adjust seq_length accordingly
        self.gru = nn.GRU(input_size=6, hidden_size=32, num_layers=2, batch_first=True)
        self.gru_fc = nn.Linear(32, 128)
        self.Wa = nn.Parameter(torch.Tensor(128, 128))  # Weight matrix for attention
        self.ba = nn.Parameter(torch.Tensor(128))  # Bias for attention
